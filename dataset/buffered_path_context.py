...
def create_standard_bpc(
    ...
    labels = numpy.empty((config.max_target_parts + 1, buffer_size), dtype=numpy.int)
    from_tokens = numpy.empty((config.max_name_parts + 1, total_num_contexts), dtype=numpy.int)
    path_types = numpy.empty((config.max_path_length + 1, total_num_contexts), dtype=numpy.int)
    to_tokens = numpy.empty((config.max_name_parts + 1, total_num_contexts), dtype=numpy.int)
